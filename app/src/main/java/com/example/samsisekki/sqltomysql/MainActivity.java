package com.example.samsisekki.sqltomysql;
...
public class MainActivity extends ActionBarActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.dbtomysql);
	...
	public void syncSQLiteMySQLDB(){
		...
		if(userList.size()!=0){
			if(controller.dbSyncCount() != 0){
				...
				client.post("http://117.17.188.146/donghyuk/tomysql/sqlitemysqlsync/insertuser.php",params ,new AsyncHttpResponseHandler() {
					@Override
